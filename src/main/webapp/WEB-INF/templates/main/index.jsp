...
<layout:main>
    ...
    <div class="container">
        <div class="container1">
            <h2 class="do-hyeon-regular">새로운 소식</h2>
            <div class="content_list">
            <div class="content"><img src="${news1Url}" alt="<fmt:message key='소식1' />"><p>2024 포켓몬 카드샵 대항전 대표 선수 결원 보충 선발전 개최안내</p></div>
            <div class="content"><img src="${news2Url}" alt="<fmt:message key='소식2' />"><p>2024 코리안 리그 파이널 시즌 대회 5월 5일~6일 in 서울 롯데호텔 월드</p></div>
    ...
    <div class="container2">
            <h2 class="do-hyeon-regular">상품</h2>
            <div class="content_list">
                <div class="content"><img src="${product1Url}" alt="<fmt:message key='상품1' />"><p>롯데 칠성 포켓몬 코코리치 출시</p></div>
            <div class="content"><img src="${product2Url}" alt="<fmt:message key='상품2' />"><p>포켓몬 콤부차 새로운 플레이버 출시</p></div>
            <div class="content"><img src="${product3Url}" alt="<fmt:message key='상품3' />"><p>가면과 타입을 바꿔서 배틀하자 오거폰 ex 등장</p></div>
            <div class="content"><img src="${product4Url}" alt="<fmt:message key='상품4' />"><p>얼려먹고 거꾸로 먹는 포켓몬 야쿠르트</p></div>
            <div class="content"><img src="${product5Url}" alt="<fmt:message key='상품5' />"><p>처음 해보는 포켓몬 카드 게임 모두 함께 배틀하자</p></div>
        </div>
    </div>
    </div>
    <div class="container3"><div class="content"><img src="${wideBannerUrl}" alt="<fmt:message key='긴배너' />"></div></div>
</layout:main>